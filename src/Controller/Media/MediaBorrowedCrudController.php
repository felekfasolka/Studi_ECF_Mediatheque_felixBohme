...
class MediaBorrowedCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInSingular('My Borrowed Items')
            ->setEntityLabelInPlural('My Borrowed Items')
            ->setSearchFields(['title', 'author', 'genre.type'])
            ->setDefaultSort(['isBorrowedAt' => 'ASC'])
            ->showEntityActionsInlined()
            ->setHelp('index', 'This section shows your borrowed & confirmed Mediatheque Items.');
