...
class EmpMediaDueCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInSingular('Due Item')
            ->setEntityLabelInPlural('Due Items')
            ->setSearchFields(['title', 'author', 'genre.type'])
            ->setDefaultSort(['isBorrowedAt' => 'ASC'])
            ->showEntityActionsInlined()
            ->setHelp('index', 'This section shows all Items due');;
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        ...
        $qb->andWhere('entity.isConfirmed = 1');
