...
class EmpMediaBorrowedCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInSingular('Borrowed Item')
            ->setEntityLabelInPlural('Borrowed Items')
            ->setSearchFields(['title', 'author', 'genre.type'])
            ->setDefaultSort(['isBorrowedAt' => 'DESC'])
            ->showEntityActionsInlined()
            ->setHelp('index', 'This section shows all Items borrowed by Users. You can confirm the borrowed Items here');;
